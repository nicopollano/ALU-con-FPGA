...
#
# Script generated by Vivado on Thu May 08 14:06:01 -0300 2025
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : SumadoRestador_bd.sh
...
#
# Usage        : SumadoRestador_bd.sh
#                SumadoRestador_bd.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                SumadoRestador_bd.sh [-reset_run]
#                SumadoRestador_bd.sh [-reset_log]
#                SumadoRestador_bd.sh [-help]
#
...
#                script (type 'SumadoRestador_bd.sh -help' for more information).
#
...
design_libs_elab="-libname util_vector_logic_v2_0_3 -libname xil_defaultlib -libname xlslice_v1_0_3 -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver util_vector_logic_v2_0_3 xil_defaultlib xlslice_v1_0_3)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "SumadoRestador_bd.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./SumadoRestador_bd.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.SumadoRestador_bd xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.SumadoRestador_bd -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log SumadoRestador_bd_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./SumadoRestador_bd.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: SumadoRestador_bd.sh [-help]\n\
Usage: SumadoRestador_bd.sh [-step]\n\
Usage: SumadoRestador_bd.sh [-lib_map_path]\n\
Usage: SumadoRestador_bd.sh [-reset_run]\n\
Usage: SumadoRestador_bd.sh [-reset_log]\n\
Usage: SumadoRestador_bd.sh [-keep_index]\n\
Usage: SumadoRestador_bd.sh [-noclean_files]\n\n\
