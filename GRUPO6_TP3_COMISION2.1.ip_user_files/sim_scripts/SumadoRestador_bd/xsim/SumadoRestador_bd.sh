...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L util_vector_logic_v2_0_3 -L xil_defaultlib -L xlslice_v1_0_3 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot SumadoRestador_bd xil_defaultlib.SumadoRestador_bd xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim SumadoRestador_bd -key {Behavioral:sim_1:Functional:SumadoRestador_bd} -tclbatch cmd.tcl -protoinst "protoinst_files/SumadoRestador_bd.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb SumadoRestador_bd.wdb xsim.dir libdpi.so)
