...
design_libs=(util_vector_logic_v2_0_3 xil_defaultlib xlslice_v1_0_3)
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.SumadoRestador_bd xil_defaultlib.glbl -o SumadoRestador_bd_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./SumadoRestador_bd_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key SumadoRestador_bd_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc SumadoRestador_bd_simv.daidir vcs_lib c.obj)
